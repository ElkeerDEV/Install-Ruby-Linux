...
RUBY_VERSION=3.3.0 # Ruby Stable Versions https://www.ruby-lang.org/en/downloads/releases/
NODE_MAJOR=20
...
apt update
apt install -y curl unzip wget zsh git-core curl zlib1g-dev build-essential libssl-dev libreadline-dev libyaml-dev libsqlite3-dev sqlite3 libxml2-dev libxslt1-dev libcurl4-openssl-dev software-properties-common libffi-dev ca-certificates gnupg
